...
form=moves~log(distance)+log(bevoelkerung_start)+log(bevoelkerung_end)+
  ...
  government_dummy_start*M08_start+government_dummy_end*M08_end|date
...
form=moves~log(distance)+log_inzidenz_start+log_inzidenz_end+
  M08_start+M08_end+
  Afd_dummy_start:M08_start+Afd_dummy_end:M08_end+
  government_dummy_start:M08_start+government_dummy_end:M08_end| start_krs+end_krs+date
...
form=moves~ log_inzidenz_start+log_inzidenz_end+
  M08_start+M08_end+
  Afd_dummy_start:M08_start+Afd_dummy_end:M08_end+
  government_dummy_start:M08_start+government_dummy_end:M08_end| start_krs+end_krs+obs+date
