...
form=moves~log(distance)+log_inzidenz_start+log_inzidenz_end+
  M17_start+M17_end+
  Afd_dummy_start:M17_start+Afd_dummy_end:M17_end| start_krs+end_krs+date
...
form=moves~ log_inzidenz_start+log_inzidenz_end+
  M17_start+M17_end+
  Afd_dummy_start:M17_start+Afd_dummy_end:M17_end+
  government_dummy_start:M17_start+government_dummy_end:M17_end| start_krs+end_krs+obs+date
fit5=feglm(form, data =data2,panel.id=c("obs","date"),vcov="hetero",family = "quasipoisson")
summary(fit5)
#add spatial lags
form=moves~ log_inzidenz_start+log_inzidenz_end+M17_start+M17_end+
  Afd_dummy_start:M17_start+Afd_dummy_end:M17_end+
