...
form=moves~log(distance)+log(bevoelkerung_start)+log(bevoelkerung_end)+
  ...
  government_dummy_start*M14_start+government_dummy_end*M14_end|date
...
form=moves~log(distance)+log_inzidenz_start+log_inzidenz_end+
  M14_start+M14_end+
  Afd_dummy_start:M14_start+Afd_dummy_end:M14_end+
  government_dummy_start:M14_start+government_dummy_end:M14_end| start_krs+end_krs+date
...
form=moves~ log_inzidenz_start+log_inzidenz_end+
  M14_start+M14_end+
  Afd_dummy_start:M14_start+Afd_dummy_end:M14_end+
  government_dummy_start:M14_start+government_dummy_end:M14_end| start_krs+end_krs+obs+date
fit5=feglm(form, data =data2,panel.id=c("obs","date"),vcov="hetero",family = "quasipoisson")

#add spatial lags
form=moves~ log_inzidenz_start+log_inzidenz_end+M14_start+M14_end+
  Afd_dummy_start:M14_start+Afd_dummy_end:M14_end+
...
etable(fit1,fit2,fit3,fit4,fit5,fit6, style.tex = style.tex("base"), tex = TRUE)
